...
image_extensions = [ ".bmp", ".gif", ".ico", ".jpeg", ".jpg", ".png", ".psd", ".tiff", ".webp", ".ai", ".cdr", ".eps", ".pdf", ".svg",
                     ".raw", ".arw", ".cr2", ".dng", ".nef", ".orf", ".pef", ".rw2", ".sr2", ".x3f", ".heic", ".indd", ".fh10", ".fh11", 
                     ".jpe", ".jfif", ".jfi", ".jp2", ".j2k", ".jpf", ".jpx", ".jpm", ".mj2", ".pcx", ".pct", ".pict", ".pic", ".pnm", 
                     ".ppm", ".pbm", ".pgm", ".ras", ".tga", ".wbmp" ]
...
def handle_request(request):
    ...
    if "Transfer-Encoding: chunked" in response_str:
        print('Handle "Transfer-Encoding: chunked"')
